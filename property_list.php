...
$sql_2 = "SELECT * FROM properties WHERE prop_city_id = $city_id";
...
<body>
    ...
    <div class="page-container">
        ...
        foreach ($properties as $property) {
            $property_images = glob("img/properties/" . $property['prop_id'] . "/*");
        ?>
                ...
                <div class="content-container col-md-8">
                    <div class="row no-gutters justify-content-between">
                        ...
                        <div class="interested-container">
                            ...
                            foreach ($interested_users_properties as $interested_user_property) {
                                if ($interested_user_property['prop_id'] == $property['prop_id']) {
                            ...
                            ?>
                                <i class="is-interested-image far fa-heart" property_id="<?= $property['prop_id'] ?>"></i>
                            <?php
                            }
                            ?>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="button-container col-6">
                            <a href="property_detail.php?property_id=<?= $property['prop_id'] ?>" class="btn btn-primary">View</a>
                        </div>
                    </div>
                </div>
            </div>
